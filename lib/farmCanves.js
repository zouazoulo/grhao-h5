...
define('farmCanves',['pixi'],function(require, exports, module){
	...
	function setup(){
		...
		//树
		tree =new Sprite.fromImage('../img/farmImg/emptyLand.png');
		tree.anchor.set(0.5);
		tree.x = w/2;
		tree.y = h / 2  +360;
   ...
   //对象
    ...
    mainView.prototype = {
    	init: function(params) {
			...
			//土地对象
			var land =new Sprite.fromImage('../img/farmImg/emptyLand.png');
       	...
       	creatTreeContainer:function(val){
			...
			//土地对象
			var newLand = new Sprite.fromImage(fruitLoge);
			...
			let Grass = {
				newGrass :function(){
					var Sprite = new _this.Sprite(id["cc2x.png"]);
						Sprite.interactive = true;
						Sprite.buttonMode = true;
						Sprite.x = newLand.x - 60
						Sprite.y = newLand.y-260;
					return Sprite;
				},
				state :"play",
				opcity:'1',
			...
			let Worm = {
				newWorm :function(){
					var Sprite = new Sprite(id["cchongx.png"]);
						Sprite.interactive = true;
						Sprite.buttonMode = true;
						Sprite.x = randomInt(tree.x-300,tree.x);
						Sprite.y =randomInt(tree.y-300,tree.y-350);
