	...
	// 命名空间
   	var farmCanves = {
   		...
   		creatMask : function(){
			...
			var cloud1 = clouds.newClouds(500,-300); //右上
			content.addChild(cloud1);
			var cloud2 = clouds.newClouds(400,200); //右中
			content.addChild(cloud2);
			var cloud3 = clouds.newClouds(600,600);//右下
			content.addChild(cloud3);
			var cloud4 = clouds.newClouds(-900,-100); //左上
			content.addChild(cloud4);
			var cloud5 = clouds.newClouds(-950,400);//左中
			content.addChild(cloud5);
			var cloud6 = clouds.newClouds(-500,1100); //下
			content.addChild(cloud6);
			var cloud7 = clouds.newClouds(0,-600);
			content.addChild(cloud7);
		}*/
   	}
