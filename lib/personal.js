	...
	pub.eventHandle.init = function(){
		...
		$('.main_top_login').click(function(){
			...
			if( common.isWeiXin() && !commom.opendId.getKey() ){
				common.jumpLinkPlain('https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxe92e098badc60fab&redirect_uri=http://wx.grhao.cn/lifei/html/login.html&response_type=code&scope=snsapi_userinfo&state=grhao&connect_redirect=1#wechat_redirect');
			}else{
				common.jumpLinkPlain('login.html');
			}
		});
