                ...
                (function(){
                    if( pub.isBase ){
						...
						if (Number(pub.orderType == 1)) {
							if (pub.allText) {
								node.eq(2).css({"margin-top":"20px","border-top":"1px solid #999","padding-top":"20px"})
								node.eq(3).css({"padding-bottom":"20px"});
							}else{
								node.eq(3).show().html( '22:30前付款，预计明日送达' ).css({"margin-top":"20px","border-top":"1px solid #999","padding":"20px 0"});
							}
						}
                    }else{
