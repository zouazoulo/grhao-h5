 	...
 	pub.init = function(){
 		...
 		*/
 		...
 		pub.isWeiXin && (function(){
 			!pub.openId ? (function(){
 				pub.weixinCode ? pub.get_weixin_code() : common.jumpLinkPlain('https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxf9dd00234aa6e921&redirect_uri=' + pub.domain + '&response_type=code&scope=snsapi_userinfo&state=grhao&connect_redirect=1#wechat_redirect');
 			}()) : (function(){
