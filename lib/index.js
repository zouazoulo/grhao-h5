 	...
 	pub.init = function(){
 		...
 		if (pub.isWeiXin) {
			...
			if (pub.logined) {
				...
				!pub.openId ? (function(){
	 				pub.weixinCode ? pub.get_weixin_code() : common.jumpLinkPlain("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxe92e098badc60fab&redirect_uri=" + pub.domain + "/lifei/index.html&response_type=code&scope=snsapi_userinfo&"+ state+ "&connect_redirect=1#wechat_redirect");
	 			}()) : (function(){
