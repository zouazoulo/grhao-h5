	...
	$.extend(ZS,{
		...
		createPopup	: function(opt) {
	        ...
	        case 10:
	            ...
	            break;
	        case 11:
	            $el.html('<span class="close"></span><h3 class="title signTitle">恭喜您获得</h3><div class="msg signList">'+msg+'</div><p class="btns signBtn"><a href="javascript:;" class="btn btn_1">' + opt.okText + '</a></p>');
	            btnClose = 'span.close';
	            btnConfirm = 'p.btns';
	            break;
	        }
