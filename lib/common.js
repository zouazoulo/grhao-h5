...
define('common',['md5','sha1','jquery','swiper','weixinSDK','module'],function(require, exports, module){
	...
	$.extend(ZS,{
		...
		//域名地址'http://wx.grhao.cn/lifei'，''
		WXDOMAIN : 'http://weixin.grhao.com',
		//appid 测试掌烁科技wxe92e098badc60fab正式果然好商城wxf9dd00234aa6e921
		WXAPPID : 'wxf9dd00234aa6e921',
	});
	// 构造HTML5存储方式 
	...
	*/
	...
	// ZS.userId = new Memory('userId','local'); // 
	// ZS.accountRelatived = new Memory('accountRelatived','local'); // 账户关联
	
	// ZS.storeInfo = new Memory('storeInfo','local'); // 存数据信息
