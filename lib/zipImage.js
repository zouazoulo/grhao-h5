define('zipImage', [], function(require, exports, module) {
	!function(e, t) {
		...
		return function(e) {
			...
			n.p = i("zipImage") + "/", window.URL = window.URL || window.webkitURL;
			var a = n(1),
				s = n(4),
				u = n(5),
				c = function(e) {
			...
			r.prototype.init = function() {
				...
				return a
			}, window.zipImage = function(e, t) {
				return new r(e, t)
			}, window.zipImage.version = "4.9.40", e.exports = window.zipImage;
		}])
	});
});