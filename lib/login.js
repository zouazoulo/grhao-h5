	...
	pub.login.eventHandle = { 
		...
		init : function(){
			...
			if( !pub.openId && common.isWeiXin() ){
				pub.weixinCode ? pub.get_weixin_code() : common.jumpLinkPlain('https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxf9dd00234aa6e921&redirect_uri=' + pub.domain + '/html/login.html&response_type=code&scope=snsapi_userinfo&state=grhao&connect_redirect=1#wechat_redirect');
			}
			// 点击跳转
